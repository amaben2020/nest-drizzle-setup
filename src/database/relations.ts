...
import { users, airtimeTransactions, billMatesFavourites, businessBranches, businessAirtimeTransactions, businessProfiles, staffProfiles, businessDataTransactions, businessPaymentTransactions, businessPins, businessPowerTransactions, businessUsers, businessRecoveryInfos, businessSettlementAccounts, businessShareholders, businessTvTransactions, businessWalletAccounts, businessWallets, businessWalletSnapshots, dashmeTransactions, dataTransactions, reasons, deletedAccounts, documentTypes, kycs, notifications, otps, pins, powerTransactions, recoveryInfos, reportPreferences, securityQuestions, transactions, tvTransactions, userAccounts, userCardDetails, userTokens, wallets, walletAccounts } from "./schema";
...
export const businessAirtimeTransactionsRelations = relations(businessAirtimeTransactions, ({one}) => ({
...
export const businessPaymentTransactionsRelations = relations(businessPaymentTransactions, ({one}) => ({
	businessBranch: one(businessBranches, {
...
export const businessPowerTransactionsRelations = relations(businessPowerTransactions, ({one}) => ({
	businessBranch: one(businessBranches, {
...
export const businessRecoveryInfosRelations = relations(businessRecoveryInfos, ({one}) => ({
	businessUser: one(businessUsers, {
...
export const businessSettlementAccountsRelations = relations(businessSettlementAccounts, ({one}) => ({
	businessProfile: one(businessProfiles, {
...
export const businessShareholdersRelations = relations(businessShareholders, ({one}) => ({
	businessProfile: one(businessProfiles, {
...
export const businessTvTransactionsRelations = relations(businessTvTransactions, ({one}) => ({
	businessBranch: one(businessBranches, {
...
export const businessWalletAccountsRelations = relations(businessWalletAccounts, ({one}) => ({
	businessProfile: one(businessProfiles, {
...
export const businessWalletsRelations = relations(businessWallets, ({one, many}) => ({
	businessWalletAccounts: many(businessWalletAccounts),
	businessProfile: one(businessProfiles, {
...
export const businessWalletSnapshotsRelations = relations(businessWalletSnapshots, ({one}) => ({
	businessProfile: one(businessProfiles, {
...
export const dashmeTransactionsRelations = relations(dashmeTransactions, ({one}) => ({
	user: one(users, {
...
export const dataTransactionsRelations = relations(dataTransactions, ({one}) => ({
	user: one(users, {
...
export const userCardDetailsRelations = relations(userCardDetails, ({one}) => ({
	user: one(users, {
