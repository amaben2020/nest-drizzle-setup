import { mysqlTable, mysqlSchema, AnyMySqlColumn, primaryKey, bigint, varchar, datetime, index, foreignKey, unique, decimal, mysqlEnum, int, tinyint, serial, text, timestamp, date, check } from "drizzle-orm/mysql-core"
...
export const businessOnboardingForms = mysqlTable("business_onboarding_forms", {
	...
	acceptsDigitalPayments: tinyint("accepts_digital_payments").default(0).notNull(),
